...
if (window.oc.remainingTimeAtStartTime === undefined) {
    window.oc.remainingTimeAtStartTime = 1049516;
}
...
window.$ = window.jquip = function() {
    function U(a, b) {
        ...
        for (var e = 0, g = V.length; e < g; e++)
            if (V[e].apply(this, arguments)) return this;
    ...
    function bb(a, b, c) {
        b = b || 0;
        if (bD(b)) return bv(a, function(a, d) {
            return !!b.call(a, d, a) === c
        });
        if (b.nodeType) return bv(a, function(a) {
            return a === b === c
        });
        if (bB(b)) {
    ...
    function bd(a) {
        if (!Z[a]) {
            var b = _("<" + a + ">").appendTo(d.body),
                c = _.css && _.css(b[0], "display") || b[0].style.display;
            b.remove(), Z[a] = c
        }
        return Z[a]
    }
    ...
    function bk(a, b, c) {
        var f = d.head || d.getElementsByTagName("head")[0] || e,
            g = d.createElement("script"),
            h;
        c && (g.async = "async"), g.onreadystatechange = function() {
            if (!(h = g.readyState) || h == "loaded" || h == "complete") g.onload = g.onreadystatechange = null, f && g.parentNode && f.removeChild(g), g = undefined, b && b()
    ...
    function bm(a, b, c) {
        if (a == null) return;
        if (R && a.forEach === R) a.forEach(b, c);
        else if (a.length === +a.length) {
            for (var d = 0, e = a.length; d < e; d++)
                if (d in a && b.call(c, a[d], d, a) === K) return
        } else
            for (var f in a)
                if (N.call(a, f) && b.call(c, a[f], f, a) === K) return
    }
    ...
    function bp(a, b) {
        ...
        for (d = 0, f = bo.length; d < f; d++)
            if (h = bo[d].exec(a)) break;
        if (d < bo.length)
            for (e = 0; g = b[e]; e++)(d == 0 && h[1] == g.id || d == 1 && bz(h[1], g.tagName) || d == 2 && bg(g, h[1]) || d == 3 && h[2] == bn(g, h[1])) && c.push(g);
        else bl(a + " not supported");
        return c
    }
    ...
    function bs(a, b, c) {
        var d = [],
            e = a[b];
        while (e && e.nodeType !== 9 && (c === undefined || e.nodeType !== 1 || !_(e).is(c))) e.nodeType === 1 && d.push(e), e = e[b];
        return d
    }
    ...
    function bw(a, b, c) {
        var d, e, f = [],
            g = 0,
            h = a.length,
            i = a instanceof _ || typeof h == "number" && (h > 0 && a[0] && a[h - 1] || h === 0 || bE(a));
        if (i)
            for (; g < h; g++) d = b(a[g], g, c), d != null && (f[f.length] = d);
        else
            for (e in a) d = b(a[e], e, c), d != null && (f[f.length] = d);
        return f.concat.apply([], f)
    }

    function bx(a, b, c) {
        if (!a) return {};
        if (b && c) return a.setAttribute(b, c), null;
        var d = {};
        return bm(by(a), function(a, b) {
            if (b.indexOf("data-") !== 0 || !a) return;
    ...
    function bI(a) {
        if (!a || bA(a) !== "object" || a.nodeType || bG(a)) return !1;
        try {
    ...
    function bO(a, b, c) {
        var d = [],
            e, f;
        for (e = 0;
            (f = a[e]) != null; e++) bB(f) && (f = bN(f, b)), f.nodeType ? d.push(f) : d = bJ(d, f);
        if (c)
            for (e = 0; e < d.length; e++) d[e].nodeType && c.appendChild(d[e]);
        return d
    }
    ...
    var a = window,
        b = "https://cdnjs.cloudflare.com/ajax/libs/sizzle/1.4.4/sizzle.min.js",
        c = function() {
        ...
        t = /\r?\n/g,
        u = /^(?:select|textarea)/i,
        v = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
    ...
    $ = U.prototype = _.prototype = _.fn = {
        ...
        dm: function(a, b, c) {
            ...
            if (d && this[0]) {
                ...
                for (i = 0, h = this.length; i < h; i++) c.call(this[i], f)
            }
            return this
        },
        ps: function(a, b, c) {
        ...
        var c = typeof a == "string" ? _(a, b) : bL(a && a.nodeType ? [a] : a),
            d = bJ(this.get(), c);
        return this.ps(ba(c[0]) || ba(d[0]) ? d : bQ(d))
    }, $.each = function(a) {
        if (!bD(a)) return this;
        for (var b = 0, c = this.length; b < c; b++) a.call(this[b], b, this[b]);
        return this
    }, $.attr = function(a, b) {
        var c = this[0];
        return bB(a) && b === undefined ? bn(c, a) : this.each(function(c) {
            ...
            if (d !== 3 && d !== 8 && d !== 2)
                if (bC(a))
                    for (var e in a) b === null ? this.removeAttribute(a) : this.setAttribute(e, a[e]);
                else this.setAttribute(a, bD(b) ? b.call(this, c, this.getAttribute(a)) : b)
        })
        ...
        var b = this,
            c, d;
        if (!bB(a)) return _(a).filter(function() {
            for (c = 0, d = b.length; c < d; c++)
                if (A(b[c], this)) return !0
        });
        var e = this.ps("", "find", a),
            f, g, h;
        ...
        for (var a = 0, b;
            (b = this[a]) != null; a++) b.parentNode && b.parentNode.removeChild(b);
        return this
        ...
        for (d = 0, l = this.length; d < l; d++) {
            ...
            while (cur) {
                ...
                cur = cur.parentNode;
                if (!cur || !cur.ownerDocument || cur === b || cur.nodeType === 11) break
            }
        }
        ...
        var b, c, d, e, f, g, h;
        if (bD(a)) return this.each(function(b) {
            ...
            for (c = 0, d = this.length; c < d; c++) {
                ...
                if (e.nodeType === 1 && e.className)
                    if (a) {
                        ...
                        for (g = 0, h = b.length; g < h; g++) f = f.replace(" " + b[g] + " ", " ");
                        e.className = x(f)
                    } else e.className = ""
            }
        }
    ...
    return A = _.contains = e.contains ? function(a, b) {
            ...
            _.fn[b] = function(c) {
                var d = [],
                    e = _(c),
                    f, g, h, i = this.length === 1 && this[0].parentNode;
                if (i && i.nodeType === 11 && i.childNodes.length === 1 && e.length === 1) return e[a](this[0]), this;
                for (f = 0, h = e.length; f < h; f++) g = (f > 0 ? this.clone(!0) : this).get(), _(e[f])[a](g), d = d.concat(g);
        ...
        function() {
            ...
            var c = /(webkit)[ \/]([\w.]+)/,
                ...
                h = c.exec(g) || d.exec(g) || e.exec(g) || g.indexOf("compatible") < 0 && f.exec(g) || [],
                i;
            i = _.browser = {
                version: h[2] || "0"
            }, i[h[1] || ""] = !0
...
$.plug("css", function(a) {
    function r(b, c, d) {
        var e = c === "width" ? b.offsetWidth : b.offsetHeight,
            f = c === "width" ? l : m;
    ...
    function s(b, c, d, e) {
        ...
        var f, g = v(c),
            ...
            i = a.cssHooks[g];
        c = a.cssProps[g] || g;
        if (d === undefined) return i && "get" in i && (f = i.get(b, !1, e)) !== undefined ? f : h[c];
        if (typeof d == "number" && isNaN(d) || d == null) return;
        typeof d == "number" && !a.cssNumber[g] && (d += "px");
        if (!i || !("set" in i) || (d = i.set(b, d)) !== undefined) try {
            h[c] = d
        } catch (j) {}
    }
    ...
    function t(b, c, d) {
        var e, f = v(c),
            g = a.cssHooks[f];
        c = a.cssProps[f] || f;
        if (g && "get" in g && (e = g.get(b, !0, d)) !== undefined) return e;
        if (n) return n(b, c, f)
    }
    ...
    function w(b, c, d, e, f, g) {
        var h = b.length;
        if (typeof c == "object") {
            for (var i in c) w(b, i, c[i], e, f, d);
            return b
        }
        if (d !== undefined) {
            e = !g && e && a.isFunction(d);
            for (var j = 0; j < h; j++) f(b[j], c, e ? d.call(b[j], j, f(b[j], c)) : d, g);
            return b
        }
    ...
    a.cssHooks = {
        ...
        a.cssHooks[b] = {
            get: function(a, c, d) {
                var e;
                if (c) return a.offsetWidth !== 0 ? r(a, b, d) : (u(a, k, function() {
                    e = r(a, b, d)
                }), e)
            },
            set: function(a, b) {
        ...
        set: function(b, c) {
            var e = b.style;
            e.zoom = 1;
            var f = a.isNaN(c) ? "" : "alpha(opacity=" + c * 100 + ")",
                g = e.filter || "";
        ...
        if (!(f = b.ownerDocument.defaultView)) return undefined;
        if (h = f.getComputedStyle(b, null)) e = h.getPropertyValue(d), e === "" && !a.contains(b.ownerDocument.documentElement, b) && (e = a.style(b, d));
        return e
    ...
    }, a.style = s, a.css = t, a.swap = u, a.camelCase = v;
    var x, y, z, A, B, C, D = function() {
            if (x) return;
            var c = b.body,
                d = b.createElement("div"),
                e, f, g, h, i = parseFloat(t(c, "marginTop")) || 0,
            ...
            a.extend(d.style, {
                ...
                height: "1px",
                visibility: "hidden"
            }), d.innerHTML = j, c.insertBefore(d, c.firstChild), e = d.firstChild, f = e.firstChild, h = e.nextSibling.firstChild.firstChild, B = f.offsetTop !== 5, C = h.offsetTop === 5, f.style.position = "fixed", f.style.top = "20px", A = f.offsetTop === 20 || f.offsetTop === 15, f.style.position = f.style.top = "", e.style.overflow = "hidden", e.style.position = "relative", z = f.offsetTop === -5, y = c.offsetTop !== i, c.removeChild(d), x = !0
        },
        E = function(a) {
            var b = a.offsetTop,
                c = a.offsetLeft;
    ...
    a.fn.offset = function() {
        ...
        var g = b.body,
            ...
            k = h.pageYOffset || a.support.boxModel && c.scrollTop || g.scrollTop,
            l = h.pageXOffset || a.support.boxModel && c.scrollLeft || g.scrollLeft,
            m = e.top + k - i,
            n = e.left + l - j;
        return {
            top: m,
        ...
        return this.map(function() {
            ...
            while (a && !j.test(a.nodeName) && t(a, "position") === "static") a = a.offsetParent;
            return a
        })
...
! function() {
    ...
    __scope_oc = window.oc, $__container_oc = $("#cdt"), periods = {
        d: 86400,
        h: 3600,
        m: 60
    }, pad = function(e) {
        for (; e.toString().length < 2;) e = "0" + e;
        return e
    }, update = function() {
        var e, o, _, t, c, i, n, r, a, d, s, p, m, l, u;
        for (s = (new Date).getTime() / 1e3, o = s - __scope_oc.startTime, o *= __scope_oc.countDirection, l = Math.max(0, Math.floor(__scope_oc.remainingTimeAtStartTime - o)), c = Math.floor(10 * (__scope_oc.remainingTimeAtStartTime - o - l)), 0 === l && (__scope_oc.countdownExpired(), c = 0), e = l - l % periods.d, i = l - e - l % periods.h, d = l - e - i - l % periods.m, u = l - e - i - d, a = [e / periods.d, pad(i / periods.h), pad(d / periods.m), pad(u)].join("x"), __scope_oc.showMilliseconds ? a = a + "p" + c : a += "bb", r = $__container_oc.find(".counter-item"), n = r.length, p = n - a.length; n--;) _ = r[n], $(_).removeClass(), $(_).addClass("counter-item"), n - p >= 0 && $(_).addClass("spr digit item-0 digit-" + a.charAt(n - p));
        return m = Math.round(($__container_oc.find(".days").innerWidth() - 60 * __scope_oc.scale) / 2), $__container_oc.find(".days .unit-label").css("left", m + "px"), t = 26 * p * __scope_oc.scale, $__container_oc.find(".digit-x").css("margin", "0 " + Math.round(t / 6) + "px")
